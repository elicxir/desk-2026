...
<p class="title-meta">ELICXIR</p>
<p class="title-date">2026-09-12</p>
...
8月にデスクを新調したのでその話。<br><br>天板の図面を描いてオーダーメイドし、<br>周辺機器を設計して3Dプリンターで実装した。
</div></div>
...
<!-- .slide: class="cover cable-management" -->

<p class="cover-rail-label">DESK<br>SETUP<br>2026</p>
<p class="cover-chapter">CHAPTER 03</p>
...
<p class="eyebrow">Cable Management</p>
...
<p class="cover-rail-label">DESK<br>SETUP<br>2026</p>
<p class="cover-chapter">CHAPTER 04</p>
...
シェルフ上に置くことを想定したトレーと腕時計を置いておくためのスタンド。<br>
...
gridfinityというグリッド形式を採用した収納システムを利用して引き出しの仕切りを作成。
...
グリッド上に規格に沿った容器(Bin)を入れることで収納を構築。一部は規格に合わせて自分で設計。
...
- 電動昇降脚とオーダーメイド天板で、使いやすいデスクを実現
- 拡張用の仕組みを組み込んだデスクシェルフを設計
- 3Dプリンタで周辺機器や収納を自作して自分に合った環境を構築

</div>

<div class="fragment fade-up" style="font-size:1.5em">

なぜわざわざ手間をかけてまでこんなことをしたのか？

</div>

<div class="fragment fade-up" style="font-size:1.2em; margin-left:24px;">

  デスク環境構築の参考にしようと Youtube で Desk Setup 系の動画を見ていた。

</div>
<div class="fragment fade-up" style="font-size:1.2em; margin-left:24px;">

  「何が必要なのか」ではなく、「XXを買いました」が先に来る　→資本主義の消費文化の奴隷
</div>



<div class="fragment fade-up" style="font-size:1.2em;margin-top:24px;">
...
自分の要求を正しく理解し、どう実現するか試行錯誤するというモノづくりの精神の体現。
</div>
